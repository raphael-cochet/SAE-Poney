...
class Reserver(db.Model):
    ...
    idCours = db.Column(db.Integer, db.ForeignKey('cours_realise.idCours'), primary_key=True)
    dateCours = db.Column(db.Date, db.ForeignKey('cours_realise.dateCours'), primary_key=True)
